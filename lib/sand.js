(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("prop-types"), require("aphrodite"));
	else if(typeof define === 'function' && define.amd)
		define("sand", ["react", "prop-types", "aphrodite"], factory);
	else if(typeof exports === 'object')
		exports["sand"] = factory(require("react"), require("prop-types"), require("aphrodite"));
	else
		root["sand"] = factory(root["react"], root["prop-types"], root["aphrodite"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_41__) {
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      if (link) {
        return _react2.default.createElement(
          'a',
          _extends({}, passedProps, { href: link, className: (0, _aphrodite.css)(_styles2.default[type]), role: 'button' }),
          this.props.children
        );
      }
      return _react2.default.createElement(
        'button',
        _extends({}, this.props, { className: (0, _aphrodite.css)(_styles2.default[type]) }),
        this.props.children
      );
    }
  }]);
...
var Checkbox = function (_Component) {
	...
	_createClass(Checkbox, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'label',
				{ htmlFor: name, className: (0, _aphrodite.css)(_styles2.default.wrapper) },
				_react2.default.createElement('input', _extends({}, this.props, { className: (0, _aphrodite.css)(this.setStyles()), checked: this.state.checked, id: name, type: 'checkbox', onChange: this.handleCheckbox })),
				_react2.default.createElement(
					'span',
					{ className: (0, _aphrodite.css)(_styles2.default.text) },
					name
				)
			);
		}
	...
	_createClass(Dropdown, [{
		...
		value: function setList() {
			...
			return list.map(function (node, i) {
				return _react2.default.createElement(
					'li',
					{ key: i, className: (0, _aphrodite.css)(_styles2.default.item) },
					(typeof node === 'undefined' ? 'undefined' : _typeof(node)) === _typeof({}) ? _react2.default.createElement(
						'a',
						_extends({}, node.props, { className: (0, _aphrodite.css)(_styles2.default.text), href: node.link || '#' }),
						node.name
					) : _react2.default.createElement(
						'span',
						{ key: i, className: (0, _aphrodite.css)(_styles2.default.text) },
						node
					)
				);
			});
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ className: (0, _aphrodite.css)(_styles2.default.caption), onClick: this.handleClick },
					label
				),
				_react2.default.createElement(
					'ul',
					_extends({}, passedProps, { className: (0, _aphrodite.css)(toggleList ? _styles2.default.listVisible : _styles2.default.listInvisible) }),
					this.setList()
				)
			);
		}
...
var Icon = function (_Component) {
	...
	_createClass(Icon, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'svg',
				{ className: (0, _aphrodite.css)(_styles2.default[appearance]), xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 1024 1024', 'aria-labelledby': 'title' },
				_react2.default.createElement(
					'title',
					null,
					name
				),
				_react2.default.createElement('path', { horizAdvX: svg.properties['horiz-adv-x'], d: svg.source })
			);
		}
	}]);
...
var Navbar = function (_Component) {
	...
	_createClass(Navbar, [{
		...
		value: function setSearchbar() {
			...
			return _react2.default.createElement(
				'form',
				{ className: (0, _aphrodite.css)(_styles2.default.searchbar), onSubmit: function onSubmit(e) {
						e.preventDefault;_this2.props.onSearch(_this2.searchInput.value);
					} },
				_react2.default.createElement('input', { className: (0, _aphrodite.css)(_styles2.default.searchInput), type: 'search', placeholder: placeholder, ref: function ref(input) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'nav',
				{ className: (0, _aphrodite.css)(_styles2.default.bar) },
				_react2.default.createElement(
					'header',
					{ className: (0, _aphrodite.css)(_styles2.default.title) },
					title
				),
	...
	_createClass(ProgressBar, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: (0, _aphrodite.css)(_styles2.default.wrapper) },
				_react2.default.createElement('div', { className: (0, _aphrodite.css)(_styles2.default[type]), style: { width: percent + '%' } })
			);
		}
	}]);
  ...
  _createClass(Select, [{
    ...
    value: function setOptions() {
      return this.props.options.map(function (node, i) {
        return _react2.default.createElement(
          'option',
          { key: i, className: (0, _aphrodite.css)(_styles2.default.item), value: (typeof node === 'undefined' ? 'undefined' : _typeof(node)) === _typeof({}) ? node.value : node },
          node.name || node
        );
      });
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'select',
        _extends({}, passedProps, { name: name, className: (0, _aphrodite.css)(_styles2.default.caption) }),
        this.setOptions()
      );
    }
  }]);
	...
	_createClass(Slider, [{
		...
		value: function setSeparators(sep) {
			...
			for (var i = 1; i < sections; i++) {
				arr.push(_react2.default.createElement('div', { key: i, className: (0, _aphrodite.css)(_styles2.default.separator), style: { left: sep * i + '%' } }));
			}
			return arr;
		}
	}, {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: (0, _aphrodite.css)(_styles2.default.container) },
				_react2.default.createElement('div', { className: (0, _aphrodite.css)(_styles2.default.circle), style: { left: sep * active / 2 + '%' } }),
				_react2.default.createElement(
					'div',
					{ className: (0, _aphrodite.css)(_styles2.default.wrapper) },
					_react2.default.createElement('div', { className: (0, _aphrodite.css)(_styles2.default.bar), style: { width: sep * active + '%' } }),
...
var Tags = function (_Component) {
	...
	_createClass(Tags, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'section',
				_extends({}, passedProps, { className: (0, _aphrodite.css)(_styles2.default.wrapper) }),
				this.props.list && this.setDatalist(uid),
				values.map(function (tag, i) {
					return _react2.default.createElement(
						'span',
						{ key: i, className: (0, _aphrodite.css)(_styles2.default.label), onClick: function onClick() {
				...
				_react2.default.createElement(
					'form',
					{ onSubmit: this.handleSubmit, className: (0, _aphrodite.css)(_styles2.default.form) },
					_react2.default.createElement('input', {
						type: 'text',
						className: (0, _aphrodite.css)(_styles2.default.input),
  ...
  _createClass(TextInput, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', _extends({}, this.props, { className: (0, _aphrodite.css)(_styles2.default[className]), disabled: className === 'disabled' ? true : disabled }))
      );
    }
  }]);
